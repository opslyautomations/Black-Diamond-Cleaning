  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        /** Hero section primary CTA — solid blue */
        hero: "bg-primary text-white hover:bg-blue-700 shadow-lg shadow-primary/25",
        /** Hero section secondary CTA — white outlined */
        "outline-light":
          "border-2 border-white/70 text-white hover:bg-white/10 backdrop-blur-sm",
        /** General conversion CTA — solid with arrow emphasis */
        cta: "bg-primary text-white hover:bg-blue-700",
      },
      size: {
        default: "h-10 px-4 py-2",
        sm: "h-9 rounded-md px-3",
        lg: "h-11 rounded-md px-8 text-base",
        xl: "h-13 rounded-lg px-8 py-3.5 text-base",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
